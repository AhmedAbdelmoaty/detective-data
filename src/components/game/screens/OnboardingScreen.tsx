...
مهمتك: كشف السبب الحقيقي قبل أن تبدأ الإدارة في اتخاذ قرارات خاطئة.`,
  ...
  },
  {
    id: 3,
    title: "الشخصيات",
    content: `ستقابل ثلاث شخصيات أساسيات داخل الشركة:

• ${CHARACTERS[0].name} - ${CHARACTERS[0].role} (يركز على إغلاق الصفقات)
• ${CHARACTERS[1].name} - ${CHARACTERS[1].role} (تدافع عن قوة الحملة)
• ${CHARACTERS[2].name} - ${CHARACTERS[2].role} (ينتظر نتيجة سريعة وواضحة)
