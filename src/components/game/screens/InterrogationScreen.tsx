...
import { CHARACTERS } from "@/data/case001";
  ...
  return (
    <>
      <InteractiveRoom
        ...
        overlayContent={
          showQuestions && selectedCharacter ? (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">كل اتهام خاطئ يقلل من فرصك في حل القضية.</p>
                  </div>
                </div>
              </motion.div>
      ...
      >
        <motion.button
          className={cn(
            ...
            isCorrectAccusation ? "bg-green-500 text-white" : "bg-destructive text-white",
          )}
          onClick={() => {
            setShowResult(false);
            onNavigate("result");
