...
export const CASE_INFO = {
  ...
  briefing: `أنت محلّل بيانات تم استدعاؤك عشان تفهم اللي بيحصل جوّه المتجر.
هتبدأ بمقابلة صاحب المتجر علشان تسمع الصورة كاملة منه.
بعد كده هتجمع معلوماتك من التقارير والمستندات، ومن كلام الموظفين جوّه المحل.
