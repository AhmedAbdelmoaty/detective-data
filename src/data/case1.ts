...
export const INTRO_SCENES: IntroScene[] = [
    ...
    dialogues: [
      {
        ...
        text: "أهلاً… الحمد لله إنك جيت. بصراحة أنا مش جايبك عشان المحل واقع أو فاضي… لا الحمد لله… المحل شغال… وفي حركة… بس الأرقام… الأرقام مش مريحة.",
        mood: "nervous",
        isSaveable: true,
        saveId: "S1",
        saveText: "أبو سعيد: المحل شغال وفي حركة، بس الأرقام مش مريحة",
      },
      {
        characterId: "abuSaeed",
      ...
      {
        characterId: "abuSaeed",
        text: "من السبت اللي فات (14 فبراير) بدأت أحس إن المحل مليان ناس… مش طول اليوم… بس في ساعات معينة، خصوصاً بعد العصر وقبل المغرب، وبالليل شوية.",
        mood: "neutral",
        isSaveable: true,
        saveId: "S3",
        saveText: "أبو سعيد: المحل مليان ناس خصوصاً بعد العصر وبالليل، من 14 فبراير",
      },
      {
        characterId: "abuSaeed",
  ...
  },
  {
    ...
    dialogues: [
      ...
      {
        characterId: "abuSaeed",
        text: "بالاتنين. أنا عندي عادة: كل آخر أسبوع بكتب رقم تقريبي في الدفتر من اللي شفته بعيني… وبعدين أقارنه بالتقرير. طول عمره فيه فرق، بس فرق منطقي. المرة دي الفرق أكبر من المعتاد.",
        mood: "suspicious",
      },
      ...
      {
        characterId: "abuSaeed",
        text: "أنا مش عايز أتهم حد. ولا عايز أفسرها على مزاجي. عشان كده جبتك… عايز أفهم اللي بيحصل من غير ما نظلم حد.",
        mood: "neutral",
        isSaveable: true,
        saveId: "S5",
        saveText: "أبو سعيد: عايز يفهم المشكلة من غير ما يظلم حد",
      },
    ],
  },
  {
    ...
    dialogues: [
      {
        characterId: "abuSaeed",
        text: "المحل ده بيعتمد على حاجتين: زباين بتيجي كل شهر/شهرين (ستات من المنطقة)، وزباين مرور… داخلين يشوفوا الجديد.",
        mood: "neutral",
      },
      { characterId: "detective", text: "في الفترة دي… الأسعار أو البضاعة اتغيروا؟", mood: "neutral" },
      {
        characterId: "abuSaeed",
        text: "الأسعار… زي ما هي تقريباً. والبضاعة… عندنا شحنة جاية قبل المشكلة بكام يوم، واتفرشت عادي… مافيش موجة شكاوى ولا تعليقات سيئة.",
        mood: "neutral",
        isSaveable: true,
        saveId: "S6",
        saveText: "أبو سعيد: الأسعار ثابتة والبضاعة الجديدة اتفرشت عادي",
      },
      { characterId: "detective", text: "طب المنافسة؟", mood: "neutral" },
      {
        characterId: "abuSaeed",
        text: "في محل قريب… مش جديد قوي، بس من فترة عامل عروض كتير. بيغير بنرات قدام المحل كل أسبوع تقريباً. هل ده مأثر؟ ممكن… بس أنا مش عايز أقول آه وخلاص.",
        mood: "suspicious",
        isSaveable: true,
        saveId: "S7",
        saveText: "أبو سعيد: في محل قريب عامل عروض كتير، بس مش متأكد إنه السبب",
      },
  ...
  },
  {
    ...
    dialogues: [
      {
        characterId: "abuSaeed",
        text: "الموضوع اللي محيرني إن التفسيرات كلها شكلها منطقي… بس أنا مش قادر أثبت أي واحد.",
        mood: "nervous",
        isSaveable: true,
        saveId: "S8",
        saveText: "أبو سعيد: كل التفسيرات شكلها منطقي بس مش قادر يثبت أي واحد",
      },
      {
        characterId: "abuSaeed",
        text: "أحياناً بحس إن الناس بتدخل كتير… بس بتشتري حاجة صغيرة وتمشي. وأحياناً بحس إن في ناس بتقعد تجرب… ومتمشيش بحاجة. وأحياناً بيحصل زحمة عند الكاشير… وتلاقي نورة بتحاول تخلص بسرعة.",
        mood: "neutral",
      },
      { characterId: "detective", text: "طب أنت معتمد في إحساسك على إيه غير النظر؟", mood: "neutral" },
      {
        characterId: "abuSaeed",
        text: "يعني… مش بس إحساس. خالد ساعات بيقولي 'النهارده في حركة بس الشراء قليل'… ونورة بتشتكي من الضغط آخر اليوم…",
        mood: "neutral",
        isSaveable: true,
        saveId: "S9",
        saveText: "أبو سعيد: خالد بيقول الشراء قليل، ونورة بتشتكي من الضغط آخر اليوم",
      },
      {
        characterId: "abuSaeed",
        text: "عايزك تبصلي في الموضوع ده بعين باردة… وتقولّي: إيه ممكن يكون سبب اللي بيحصل ده. اعتبرني مش طالب منك اتهام… أنا طالب منك فهم.",
        mood: "neutral",
      },
    ],
  },
