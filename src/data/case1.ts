...
export const ROOMS: Room[] = [
  {
    id: "manager-office",
    name: "مكتب معتز",
    nameEn: "Manager's Office",
    description: "مكتب المدير العام - البداية والنهاية",
    icon: "🏢",
...
export const CHARACTERS: Character[] = [
  {
    ...
    room: "manager-office",
    avatar: "/characters/moataz.png",
    personality: "قلق على الشركة، يريد حلاً سريعاً",
    isGuilty: false,
    initialStatement: "المصاريف زادت بشكل غريب... أنا بفكر أوقف محمود مؤقتاً لحد ما نفهم إيه اللي بيحصل.",
    dialogues: [
      {
        id: "moataz-first",
        trigger: "first_visit",
        text: "المصاريف زادت بشكل غريب... أنا بفكر أوقف محمود مؤقتاً لحد ما نفهم إيه اللي بيحصل. إيه رأيك؟",
        choices: [
          {
            id: "stop-mahmoud",
            text: "أوقفه فوراً",
            ...
            followUp: "تم إيقاف محمود. لكن خليك فاكر إنك ممكن تكون خسرت معلومات مهمة منه.",
          },
          {
            id: "wait",
            text: "استنى لحد ما أشوف الأدلة",
            result: "trust_up",
            trustChange: { entity: "manager", amount: 10 },
            followUp: "قرار حكيم. هتقدر تتكلم مع الكل وتجمع معلومات أكتر.",
          },
        ],
      },
      {
        ...
        choices: [
          {
            ...
            followUp: "هشوف محمود بعين تانية...",
          },
          {
            id: "suspect-accounting",
            text: "في حاجة غلط في المحاسبة",
            result: "clue",
            clue: "معتز هيسمحلك تشوف ملفات أكتر في المحاسبة",
            followUp: "مثير للاهتمام... خد صلاحية كاملة على ملفات المحاسبة.",
          },
          {
            id: "suspect-supplier",
            ...
            followUp: "النور للتوريدات؟ خد صلاحية تشوف ملف المدفوعات.",
          },
          {
            id: "still-investigating",
            text: "لسه بدور",
            result: "close",
            followUp: "خد وقتك، بس متنساش إن المستثمر جاي قريب.",
          },
        ],
      },
    ],
  },
  {
    ...
    name: "سارة",
    nameEn: "Sara",
    role: "مسؤولة الفواتير",
    roleEn: "Invoice Manager",
    room: "accounting",
    avatar: "/characters/sara.png",
    personality: "تبدو محترفة، لكنها المذنبة الحقيقية",
    isGuilty: true,
    ...
    dialogues: [
      {
        ...
        choices: [
          ...
          },
          {
            ...
            result: "refuse",
            followUp: "المدفوعات؟ دي محتاج موافقة من معتز الأول. الفواتير أهم دلوقتي.",
          },
        ],
      },
      {
...
export const EVIDENCE_ITEMS: Evidence[] = [
  ...
  },
  {
    ...
    isLocked: true,
    unlockCondition: "طلب من معتز أو insight عن المورد",
    data: {
      type: "payments",
      payments: [
