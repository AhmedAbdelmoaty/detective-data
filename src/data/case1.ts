...
export const HYPOTHESES: Hypothesis[] = [
  { id: "H1", text: "الزباين بقت تشتري أقل", description: "سلة الشراء / عدد القطع في الفاتورة أقل", isCorrect: false, category: "primary" },
  { id: "H2", text: "منافس قريب بيسحب جزء من الشراء", description: "عروض وإعلانات مغرية من محل مجاور", isCorrect: false, category: "primary" },
  { id: "H3", text: "مرتجعات/خصومات بعد البيع", description: "مرتجعات وخصومات بتخلي الصافي أقل", isCorrect: true, category: "primary" },
  { id: "H4", text: "أخطاء تسجيل وقت الذروة", description: "وقت الزحمة بيحصل لخبطة: حاجة ما بتتسجلش أو بتتلغى بالغلط", isCorrect: false, category: "primary" },
  { id: "H5", text: "الموسم هادي والطلب أضعف", description: "الطلب أقل طبيعياً في الفترة دي", isCorrect: false, category: "secondary" },
  { id: "H6", text: "نقص مقاسات/مخزون", description: "الزبون عايز بس مش لاقي مقاسه", isCorrect: false, category: "secondary" },
  { id: "H7", text: "الأسعار مش مناسبة", description: "الناس بتتراجع بسبب السعر", isCorrect: false, category: "secondary" },
  { id: "H8", text: "سرقة/تلف ملحوظ", description: "حاجة بتقلل الإيراد من غير ما حد يحس", isCorrect: false, category: "secondary" },
];
    ...
    dialogues: [
      {
        ...
        isSaveable: true,
        saveId: "S1",
        saveText: "أبو سعيد: المحل فيه حركة، بس الأرقام مش مريحة",
      },
      {
        characterId: "abuSaeed",
        text: "تشرب شاي؟… قلت أهو نقعد دقيقتين بهدوء.
أنا بقالي يومين دماغي مش سايباني… وقلت لازم أقابلك وأحكيلك اللي حاصل.",
        mood: "neutral",
      },
      ...
      {
        characterId: "abuSaeed",
        text: "أنا بقالي في الشغلانة دي أكتر من 12 سنة. عينك بتتعود… بتعرف اليوم عامل إزاي من أول ساعتين.
بس اللي حصل آخر أسبوع خلاني حاسس إني مش فاهم الدنيا.",
        mood: "suspicious",
        isSaveable: true,
        saveId: "S2",
        saveText: "أبو سعيد: 12 سنة خبرة، بس اللي حصل آخر أسبوع محيّره",
      },
      { characterId: "detective", text: "إيه اللي خلاك تقلق؟", mood: "neutral" },
      {
        characterId: "abuSaeed",
        text: "خليني أحكي من الأول… من السبت اللي فات (14 فبراير) بدأت أحس إن المحل ‘مليان ناس’…
مش طول اليوم… بس في ساعات معينة، خصوصًا بعد العصر وبالليل شوية.",
        mood: "neutral",
        isSaveable: true,
        saveId: "S3",
        saveText: "أبو سعيد: المحل مليان ناس في ساعات معينة من 14 فبراير",
      },
      {
        characterId: "abuSaeed",
        text: "هتلاقي ناس بتجرب… ناس بتسأل… ناس بتدخل وتطلع…
فأنا طبيعي أتوقع إن اليوم ده هيطلع رقم كويس.",
        mood: "neutral",
      },
    ],
  },
  {
    ...
    dialogues: [
      {
        characterId: "abuSaeed",
        text: "بس لما قعدت آخر الأسبوع أبص على اللي اتسجل… لقيت إن الرقم أقل من اللي في دماغي.
مش فرق بسيط… فرق يخليك تقول: في حاجة غلط.",
        mood: "nervous",
        isSaveable: true,
        saveId: "S4",
        saveText: "أبو سعيد: الرقم المسجل أقل من المتوقع بفرق كبير",
      },
      { characterId: "detective", text: "دماغك بتقارن بإيه؟ بإحساسك؟ ولا بأرقام قديمة؟", mood: "neutral" },
      {
        characterId: "abuSaeed",
        text: "بالإتنين.
أنا عندي عادة: كل آخر أسبوع بكتب رقم تقريبي في الدفتر ده كده من اللي شفته بعيني…
وبعدين أقارنه بالتقرير. طول عمره فيه فرق، بس فرق منطقي.
المرة دي الفرق أكبر من المعتاد.",
        mood: "suspicious",
      },
      { characterId: "detective", text: "طيب يمكن الحركة اللي شايفها مش شراء؟ ناس بتتفرج بس؟", mood: "neutral" },
      {
        characterId: "abuSaeed",
        text: "ده احتمال… بس برضه فيه حاجة مش راكبة.
يعني… في أيام بعينها أنا شفت بعيني أكتر من حد دافع وطلع بكيس.",
        mood: "nervous",
      },
      {
        characterId: "abuSaeed",
        text: "أنا قعدت ألفّها في دماغي كذا مرة… وكل ما أقول تفسير، ألاقيه ناقص.
حاسس إن فيه تفصيلة صغيرة بتفلت مني…
عشان كده جبتك…
عايزك ترتب اللي حاصل ده معايا… وتفسرلي الفرق ده طالع منين.",
        mood: "neutral",
        isSaveable: true,
        saveId: "S5",
        saveText: "أبو سعيد: تفسيراته ناقصة وعايز ترتيب اللي حاصل",
      },
    ],
  },
  {
    ...
    dialogues: [
      {
        characterId: "abuSaeed",
        text: "المحل هنا بيعتمد على حاجتين: 
زباين بتيجي كل شهر/شهرين 
وزباين مرور… داخلين يشوفوا الجديد.",
        mood: "neutral",
      },
      { characterId: "detective", text: "في الفترة دي… الأسعار أو البضاعة اتغيروا؟", mood: "neutral" },
      {
        characterId: "abuSaeed",
        text: "الأسعار… ما اتحركتش حركة كبيرة.
والبضاعة… عندنا بضاعة جديدة استلمناها من حوالي 10 أيام واتفرشت في المحل…
مش شايف شكاوى كبيرة ولا تعليقات كتير.
(أنا بتابع الكلام ده… لو في حد من العملاء معاه مشكلة أو متضايق من حاجة بعرف).",
        mood: "neutral",
        isSaveable: true,
        saveId: "S6",
        saveText: "أبو سعيد: الأسعار ما اتحركتش والبضاعة الجديدة اتفرشت",
      },
      {
        characterId: "abuSaeed",
        text: "أنا اللي يهمّني إن الزبون يطلع مطمّن…
لو مقاس طلع مش مظبوط بنبدّل، ولو حد اخد حاجه معجبتوش او فيها مشكلة بيرجعها عادي… المهم الناس تفضل واثقة.",
        mood: "neutral",
      },
      { characterId: "detective", text: "طب والشارع حواليك؟… ايه اخبار المنافسين؟", mood: "neutral" },
      {
        characterId: "abuSaeed",
        text: "في محل جنبنا… مش جديد قوي، بس من فترة عامل عروض.
وبيغير بنرات قدام المحل كل أسبوع تقريبًا… الناس بتلاحظ ده.
هل ده مأثر؟ ممكن… بس أنا مش عايز أقول آه وخلاص.",
        mood: "suspicious",
        isSaveable: true,
        saveId: "S7",
        saveText: "أبو سعيد: محل جنبهم عامل عروض وبنرات بتتغير",
      },
      { characterId: "detective", text: "طيب الموظفين… نفسهم؟ ولا في تغيير حصل؟", mood: "neutral" },
      {
        characterId: "abuSaeed",
        text: "لا نفسهم… خالد مدير الصالة… ونورة على الكاشير…
الناس دي معايا من فترة…
وعشان كده الموضوع مضايقني… لأن مفيش تغيير كبير حصل يخلي ده يحصل فجأة.",
        mood: "nervous",
      },
    ],
  },
  {
    ...
    dialogues: [
      {
        characterId: "abuSaeed",
        text: "اللي محيّرني إن الصورة مش ثابتة… كأن كل يوم بيحكي حكاية غير اللي قبله.
يعني مثلًا…",
        mood: "nervous",
        isSaveable: true,
        saveId: "S8",
        saveText: "أبو سعيد: الصورة مش ثابتة وكل يوم بيحكي حكاية",
      },
      {
        characterId: "abuSaeed",
        text: "في أيام… تلاقي الداخلين كتير، وتقول: نهارده هيتقفل كويس…
وبعدين تلاقي اللي طالع… طالع بحاجة خفيفة
وأحيانًا بحس إن في ناس بتقعد تجرب… ومتمشيش بحاجة.
وساعات بيحصل زحمة عند الكاشير… ونورا بتحاول تخلّص بسرعة عشان الطابور ما يطوّلش….",
        mood: "neutral",
      },
      { characterId: "detective", text: "طب أنت معتمد في إحساسك على إيه غير النظر؟", mood: "neutral" },
      {
        characterId: "abuSaeed",
        text: "يعني… مش بس إحساس.
خالد ساعات بيقولي ‘النهارده في حركة بس الشراء قليل’…
ونورة بتشتكي من الضغط آخر اليوم…
وأنا بنفسي بعد ما نقفل، ببص على ملخص اليوم اللي بيتطبع من الجهاز… بس مش بفهم منه كل التفاصيل.",
        mood: "neutral",
        isSaveable: true,
        saveId: "S9",
        saveText: "أبو سعيد: خالد بيقول الشراء قليل ونورة بتشتكي من الضغط",
      },
      {
        characterId: "abuSaeed",
        text: "الورقة دي فيها أرقام… بس أنا مش عارف أقرأها صح ولا غلط.
كل اللي أعرفه: الرقم النهائي أقل من اللي متوقعه.",
        mood: "neutral",
      },
      {
        characterId: "abuSaeed",
        text: "الورق كله تحت إيدك—التقارير والدفتر والفواتير، وأي حاجة طالعة من الجهاز.
وكمان اقعد مع خالد شوية في الصالة، ومع نورا على الكاشير…
واسأل اللي محتاجه… وفي الآخر قولي: الخلل فين بالظبط؟",
        mood: "neutral",
      },
    ],
  },
...
export const CHARACTERS: GameCharacter[] = [
  ...
  },
  {
    ...
    interviewId: "I1",
    dialogues: [
      { characterId: "detective", text: "خالد، أبو سعيد قال لي إنك ماسك الصالة. إيه ملاحظاتك الفترة دي؟", mood: "neutral" },
      {
        characterId: "khaled",
...
export const DASHBOARD_DATA: DashboardItem[] = [
  ...
  // D2 - عدد الفواتير يومياً
  {
    ...
    type: "line",
    data: {
      labels: ["6/2", "7/2", "8/2", "9/2", "10/2", "11/2", "12/2", "13/2", "14/2", "15/2", "16/2", "17/2", "18/2", "19/2", "20/2"],
...
export const ENDINGS: Ending[] = [
  {
    ...
    abuSaeedDialogues: [
      ...
      { characterId: "detective", text: "المشكلة في المرتجعات والخصومات بعد البيع. الأرقام زادت بشكل واضح الأسبوع ده.", mood: "suspicious" },
      { characterId: "abuSaeed", text: "يعني… المرتجعات هي اللي بتاكل الصافي؟!", mood: "angry" },
      { characterId: "detective", text: "بالظبط. المرتجعات زادت من 14 لـ 27، وقيمتها من 2,900 لـ 6,500. ده بيفسر الفرق اللي بتحس بيه.", mood: "neutral" },
      { characterId: "abuSaeed", text: "ممتاز يا أستاذ! تحليلك دقيق ومبني على أدلة قوية. لازم أراجع سياسة المرتجعات فوراً!", mood: "happy" },
    ],
    lesson: "الحل الصحيح هو H3: مرتجعات/خصومات بعد البيع. القطع المباعة شبه ثابتة (K2 نفى H1)، وتسوية المدفوعات سليمة (K5 نفى H4)، والمخزون كامل (K6 نفى H6/H8)، والأسعار ثابتة (K1 نفى H7). ملخص بعد البيع (K4) أكد إن المرتجعات زادت بوضوح.",
  },
  {
    id: "ending-partial",
    type: "partial",
    ...
    consequences: [
      ...
      "يتم مراقبة المرتجعات بدون إجراء فوري",
    ],
    score: 250,
    abuSaeedDialogues: [
    ...
    lesson: "وصلت للفرضية الصحيحة (H3) لكن كان لازم تجمع الأدلة التشخيصية: ملخص بعد البيع (K4)، القطع المباعة حسب الصنف (K2)، ورأي الزبونة (I3).",
  },
  {
    id: "ending-wrong",
    type: "wrong",
    ...
    consequences: [
      ...
      "المشكلة الحقيقية (المرتجعات) تفضل موجودة",
      "خسائر المحل هتزيد",
    ],
    score: 50,
    abuSaeedDialogues: [
    ...
    lesson: "الحل الصحيح كان H3: مرتجعات/خصومات بعد البيع. كل فرضية غلط كان فيه دليل واحد على الأقل بينفيها بقوة (--). في تحليل ACH، الفرضية اللي ما عندهاش أي تناقض قوي هي الأرجح.",
  },
  {
    id: "ending-missing",
    type: "missing",
    ...
    lesson: "أهم درس في تحليل ACH: لا تستبعد أي فرضية بدون دليل قوي ينفيها! الفرضية الصحيحة (H3: مرتجعات بعد البيع) كانت لازم تكون ضمن الأربعة عشان تقدر تحللها.",
  },
];
